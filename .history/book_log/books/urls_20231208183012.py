...
from .views import (
    ...
    write_review,
    save_review,
    search_google_books,  # Import the save_review view
) 
...
urlpatterns = [
    ...
    path('search-google-books/', search_google_books, name='search_google_books'),# Add the URL pattern for save_review
